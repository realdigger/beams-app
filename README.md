...
Для активного длинного цикла отчёт также содержит его тип, текущий день
контроллера, длительность, TGI, рассчитанный TGE и точки DLI. Это помогает
сопоставить график и TGE приложения с показаниями светильника.
